        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <div className="relative z-10 max-w-2xl mx-auto">
            ...
            <h3 className="font-serif-heading text-2xl md:text-4xl font-bold mb-3 text-white">
              Ready to Partner With an Established Tirupur Exporter?
            </h3>
            <p className="text-xs sm:text-sm text-brand-bg/85 leading-relaxed mb-8 font-medium">
              Join leading apparel labels across Europe, North America, and the Middle East. Request samples and custom manufacturing quotes today.
            </p>
            <Link
              href="/contact"
